...
const { User, Enemy, Book, Section } = require('../models');
...
const enemys = [
	{
		...
		damage_Low: 8,
		description:
			'William Shakespeare, Shakespeare also spelled Shakspeare, byname Bard of Avon or Swan of Avon, English poet, dramatist, and actor often called the English national poet and considered by many to be the greatest dramatist of all time.',
	},
	{
		name: 'Oscar Wilde',
	...
	},
	{
		name: 'Mary Shelly',
		description:
			' This lady wrote a book about a monster but its not THE monster, its the guy who made it! ',
		hit_Points: 60,
		attack_Speed: 12000,
		damage_High: 10,
		damage_Low: 4,
...
const books = [
	...
	},
	{
		name: 'Romeo & Juliet',
		description:
			'The Romeo and Juliet play is set in Renaissance Verona in Italy. In the Elizabethan imagination that would have presented a picture of heat, quick tempers and violence.',
		enemy_Id: 1,
	},
	{
		name: 'Macbeth',
		description:
			'In Macbeth, the murder of a king by one of his subjects is seen as unnatural and the images of the play reflect this theme, with disruptions of nature, like storms and events such as where the horses turn on their grooms and bite them. In Macbeth Shakespeare explores what it is to be a man. Lady Macbeth accuses Macbeth of being unmanly because of his hesitation in killing Duncan, but Macbeth says that it’s unmanly for a man to kill his king. Shakespeare plays with that paradox. Duncan is a good king and a good man, and he is surrounded by images of light. Macbeth and Lady Macbeth turn their surroundings into a picture of hell, blanketed in darkness. Those images of light and dark interact throughout the play.',
		enemy_Id: 1,
	},
];
const sections = [
